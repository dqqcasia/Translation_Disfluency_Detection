...
class NA_Transformer(Model):
    def __init__(self, *args, **kargs):
        super(NA_Transformer, self).__init__(*args, **kargs)
    ...
    def decoder_impl(self, decoder_input, encoder_latent, encoder_output, is_training):
        ...
        decoder_output = tf.multiply(decoder_output, encoder_latent)
